import type { CommandRecord } from "../protocol/messages.js";

export const COMMAND_CATALOG: CommandRecord[] = [
  {
...
export function promptForCommand(commandId: string): string | undefined {
  switch (commandId) {
    case "codex.status":
