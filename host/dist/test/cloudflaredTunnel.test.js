...
describe("cloudflared quick tunnel helpers", () => {
    it("extracts the generated trycloudflare url from cloudflared logs", () => {
        ...
        expect(toWebSocketTunnelUrl("https://administrative-preview-travelling-violations.trycloudflare.com")).toBe("wss://administrative-preview-travelling-violations.trycloudflare.com");
    });
});
